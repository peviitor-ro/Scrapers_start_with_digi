...
def collect_data_from_restart() -> list:
    """
...
data_list = collect_data_from_restart()
scrape_and_update_peviitor(company_name, data_list)

print(update_logo('restartenergy', 'https://restartenergy.ro/wp-content/uploads/2017/01/logo-site3.png'))
