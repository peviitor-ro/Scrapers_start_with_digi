...
def update_delgazgrid():
    ...
    clean_request = requests.post(CLEAN_URL, headers=clean_header, data={'company': 'delgazgrid'})
    ...
    with open('scrapers_forzza/data_delgazgrid.json', 'r') as file:
        data = json.load(file)
