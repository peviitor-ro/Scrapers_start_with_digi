...
def update_threatconnect():
    ...
    clean_request = requests.post(CLEAN_URL, headers=clean_header, data={'company': 'threatconnect'})
    ...
    with open('scrapers_forzza/data_threatconnect.json', 'r') as file:
        data = json.load(file)
