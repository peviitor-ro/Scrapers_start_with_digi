...
def update_proctergamble():
    ...
    clean_request = requests.post(CLEAN_URL, headers=clean_header, data={'company': 'proctergamble'})
    ...
    with open('scrapers_forzza/data_proctergamble.json', 'r') as file:
        data = json.load(file)
