...
def get_county(location: str):
    """
    Retrieve county information based on location data.

    If the county is found in the keys or the first element of the values, the function returns a tuple (key, True).

    If the county cannot be found, the function returns a tuple (location, False).
