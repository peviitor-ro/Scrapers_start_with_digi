...
def scrape_all_data_from_softserveinc() -> list:
    """
...
data_list = scrape_all_data_from_softserveinc()
scrape_and_update_peviitor(company_name, data_list)

print(update_logo('softserveinc',
                  'https://www.softserveinc.com/cdn/img/root/black-logo-root.svg'
                  ))
